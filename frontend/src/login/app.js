...
export default function AuralisLogin() {
  ...
  const glowA = useFloat({
    ax: 24,
    ay: 18,
    phase: 0,
  });

  const glowB = useFloat({
    ax: 22,
    ay: 20,
    phase: 3,
  });
    ...
    try {
      ...
      setTimeout(() => {
        if (backendRole === "Admin") {
          navigate("/admin");
        } else if (backendRole === "Penyelenggara") {
          navigate("/organizer");
        } else {
          navigate("/home");
        }
  ...
  return (
    ...
    >
        ...
        {submitted ? (
          ...
          <>
            ...
            >
              ...
              >
                Masuk ke akun Auralis Anda untuk melanjutkan
              </p>
            </div>
      ...
      >
        <span>
          Bergabung dengan 50k+ penonton konser musik
        </span>
      </div>
    </div>
  );
